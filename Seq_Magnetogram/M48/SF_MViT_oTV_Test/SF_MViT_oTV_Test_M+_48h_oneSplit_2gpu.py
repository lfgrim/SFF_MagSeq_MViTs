...
#oversample train
oversample('Seq16_flare_Mclass_48h_train3.txt')
#oversample val
oversample('Seq16_flare_Mclass_48h_val3.txt')
#oversample test
oversample('../Seq16_flare_Mclass_48h_Test.txt')


# In[ ]:

train_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_train3.txt_over',
                               transform=transform_train, etapa='train')
val_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_val3.txt_over',
                             transform=transform_valid, etapa='val')
test_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','../Seq16_flare_Mclass_48h_Test.txt_over',
...
flaresRAsTrain = pd.read_csv('Seq16_flare_Mclass_48h_train3.txt_over', sep=' ', dtype='str')
flaresRAsVal = pd.read_csv('Seq16_flare_Mclass_48h_val3.txt_over', sep=' ', dtype='str')
flaresRAsTest = pd.read_csv('../Seq16_flare_Mclass_48h_Test.txt_over', sep=' ', dtype='str')
