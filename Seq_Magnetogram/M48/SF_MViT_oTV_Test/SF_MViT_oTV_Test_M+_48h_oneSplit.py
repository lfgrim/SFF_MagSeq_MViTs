...
#oversample train
oversample('Seq16_flare_Mclass_48h_train1.txt')
#oversample val
...
train_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_train1.txt_over',
                               transform=transform_train, etapa='train')
val_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_val1.txt_over',
...
flaresRAsTrain = pd.read_csv('Seq16_flare_Mclass_48h_train1.txt_over', sep=' ', dtype='str')
flaresRAsVal = pd.read_csv('Seq16_flare_Mclass_48h_val1.txt_over', sep=' ', dtype='str')
