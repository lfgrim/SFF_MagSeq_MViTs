...
os.system('cat ' + train1 + train2 + train3 + train4 + ' > Seq16_flare_Mclass_48h_train1.txt') 
os.system('cat ' + val + ' > Seq16_flare_Mclass_48h_val1.txt')

# In[ ]:

train_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_train1.txt', transform=transform_train)
val_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_48h_val1.txt', transform=transform_valid)
...
flaresRAsTrain = pd.read_csv('Seq16_flare_Mclass_48h_train1.txt', sep=' ', dtype='str')
flaresRAsVal = pd.read_csv('Seq16_flare_Mclass_48h_val1.txt', sep=' ', dtype='str')
