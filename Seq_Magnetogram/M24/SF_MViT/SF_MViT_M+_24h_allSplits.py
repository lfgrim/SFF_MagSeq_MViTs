...
for k in range(5):
    ...
    #oversample train
    #oversample('Seq16_flare_Mclass_24train1.txt')
    #oversample val
    ...
    train_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_24h_train1.txt', 
                                   transform=transform_train, etapa='train')
    val_dataset = Mflare_Dataset('../../../magnetogram_jpg/','../Seqs16/','Seq16_flare_Mclass_24h_val1.txt', 
    ...
    flaresRAsTrain = pd.read_csv('Seq16_flare_Mclass_24h_train1.txt', sep=' ', dtype='str')
    flaresRAsVal = pd.read_csv('Seq16_flare_Mclass_24h_val1.txt', sep=' ', dtype='str')
